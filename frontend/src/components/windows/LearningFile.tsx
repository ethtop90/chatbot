...
const LearningFile: React.FC<LearningFileProps> = ({
  files,
  setFiles,
  uploadStatuses,
  setUploadStatuses,
  ...
  return (
    <div className="max-h-full h-full flex flex-col">
      <div className="pt-[37px] px-[37px] h-full overflow-y-auto">
        <div className="bg-[#E9E9E9] px-auto flex justify-center pb-10">
            ...
            <div className="border-none rounded-lg w-[500px]">
              ...
              {uploadStatuses.map((upload, index) => (
                ...
                >
                  ...
                  <div className="flex flex-col w-[150px] h-[56px]">
                    <p className="font-bold text-[16px] w-full whitespace-nowrap overflow-hidden text-ellipsis">
                      {upload.fileName}
                    </p>
